...
class LeftPanel(QWidget):
    def __init__(self, kernel_sources: list[str]) -> None:
        ...
        self.config_choice = QComboBox(); self.config_choice.addItems(["DFUSE 7.2", "Zen 7.2", "Manjaro 7.2 (Golden)", "DFUSE Legacy", "DFUSE Slim"]); layout.addWidget(self.config_choice)
