...
class LeftPanel(QWidget):
    def __init__(self, kernel_sources: list[str]) -> None:
        ...
        self.config_choice = QComboBox(); self.config_choice.addItems(["DFUSE 7.2", "Zen 7.1.3", "Manjaro 7.2 (Golden)", "DFUSE Legacy", "DFUSE Slim"]); layout.addWidget(self.config_choice)
        ...
        self.apply_xbox = QCheckBox("Enable Xbox Controller Support")
        self.apply_xbox.setChecked(True)
        layout.addWidget(self.apply_xbox)
